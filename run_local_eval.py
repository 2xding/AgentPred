...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Sandbox image override. Defaults to the competition image, which is amd64-only; "
        "pass a local arm64 stand-in (e.g. aap-sandbox:local) to run on Apple Silicon.",
    )
    parser.add_argument(
        "--num-retries",
        type=int,
    ...
    config = EvaluationConfig(
        ...
        **({"docker_image": args.docker_image} if args.docker_image else {}),
